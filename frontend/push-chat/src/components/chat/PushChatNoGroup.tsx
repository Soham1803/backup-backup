...
const PushChatNoGroup = () => {
    ...
    return (
        ...
        <div>
            {
                user !== null && user !== undefined && <DMRequests pushChatUser={user} />
            }
            <h1>PPP Chat</h1>
            <h2>{senderAddress}</h2>
            <br />
            {
                recAddress === "" || user === null || user === undefined ? <InputFormEthAddress setValue={setRecAddress} /> : <Pppchat receiver={recAddress} user={user} />
            }
